...
include_once("../model/get_curators_historic_songs.php");				
	...
	if($trackList = $req->fetch())
	{
		...
		{				
				...
				//Playlist
				echo(' Playlist: <span class="KeyFigure">'.$Playlist['0'].'</span> - ');
				echo(' Likes: <span class="KeyFigure">'.$nblikes['0'].'</span> - ');
