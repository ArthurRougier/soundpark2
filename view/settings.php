  ...
  <head>
	...
	<body>
		<header>
			...
			<ul>
				<li><a id="my_account_tab" style="color: white; border-bottom: 1px solid white;" href="../view/settings.php">My account</a></li>
				<li><a id="my_songs_tab" href="likes.php">My Songs</a></li>
